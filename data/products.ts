...
export type ProductDictionary = Record<
  string,
  Record<string, Record<string, Record<string, Product>>>
>;
    ...
    apparel: {
      shirts: {
        "alpine-trail-shirt-1": {
          ...
          description:
            "Show your support for Alpine Trail Co. with our signature t-shirt. Made from a comfortable cotton blend...",
          images: [
            {
              id: "1",
