...
export default function ExpeditionBumperPage() {
    ...
    <div className="bg-white">
      <div className="container mx-auto px-4 py-12">
        <nav className="flex items-center text-sm text-gray-500 mb-8">
          ...
          <ChevronRight className="h-4 w-4 mx-2" />
          <span className="font-medium text-gray-800">Expedition Series Front Bumper</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="aspect-square w-full rounded-lg overflow-hidden bg-gray-100 mb-4">
              <Image
                ...
                alt="Expedition Series Front Bumper"
                width={800}
                height={800}
          ...
          {/* Product Info */}
          <div>
            <h1 className="text-3xl lg:text-4xl font-bold tracking-tight text-gray-900">Expedition Series Front Bumper</h1>
            <p className="mt-4 text-3xl text-gray-900">$1,850.00</p>
            ...
            <div className="mt-8">
              ...
              <div className="mt-4 text-gray-600 space-y-4">
                <p>
                  The Alpine Trail Co. Expedition Series Front Bumper for the 4th Gen 4Runner is the ultimate in front-end protection and utility. Designed for the serious overlander, this bumper provides robust protection while offering mounting solutions for winches, lights, and other essential recovery gear.
                </p>
                <p>
                  Our bumpers are engineered to be a perfect, bolt-on fit for your vehicle, ensuring a straightforward installation process and a clean, integrated look.
                </p>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <ul className="mt-4 list-disc list-inside text-gray-600 space-y-2">
                <li>Full-width design for maximum protection</li>
                <li>Integrated winch mount (fits most standard winches)</li>
                <li>Multiple light mounting options</li>
                <li>CNC cut and formed from high-strength steel</li>
                <li>Durable black powder coat finish</li>
                <li>Bolt-on installation, no cutting required</li>
              </ul>
            </div>
