...
const product = {
  ...
  price: 129.99,
  images: [
    { id: 1, src: "/images/4runner-molle-panel-installed-1.jpeg", alt: "Center Console MOLLE Panel installed" },
    { id: 2, src: "/images/4runner-molle-panel-installed-2.jpeg", alt: "Center Console MOLLE Panel with gear" },
  ],
  description: "Add accessible storage to your center console with these easy-to-install CNC cut steel panels. Perfect for mounting pouches, holsters, phone holders, and other small gear, keeping your essentials within arm's reach.",
  includedHardware: [
  ...
  installationTip: "Do not use a power drill to avoid stripping the plastic. Hand tightening is recommended.",
}
          ...
          <div>
            ...
            <Accordion type="single" collapsible defaultValue="item-1" className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger className="text-lg font-semibold">Included Hardware</AccordionTrigger>
                <AccordionContent>
              ...
              <AccordionItem value="item-2">
                <AccordionTrigger className="text-lg font-semibold">Installation Guide</AccordionTrigger>
                <AccordionContent>
