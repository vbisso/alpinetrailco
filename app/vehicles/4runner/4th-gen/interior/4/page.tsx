...
export default function FourRunnerFourthGenRearCargoMollePanelPage() {
  ...
  const product = {
    ...
    specifications: [
      ...
      {
        label: "Installation",
        value: "Drop-in fit within factory storage compartment",
      },
      {
        label: "Compatibility",
        value: "All 4th Gen Toyota 4Runner models (2003-2009)",
      },
    ],
    installation: [
    ...
    <div className="min-h-screen bg-white">
      <div className="container px-4 py-12">
        ...
        <div className="flex items-center text-sm text-gray-500 mb-8">
          ...
          <ChevronRight className="h-4 w-4 mx-2" />
          <Link
            href="/vehicles/4runner/4th-gen/interior"
            className="hover:text-gray-700"
          >
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div>
            ...
            <Tabs defaultValue="features" className="w-full mt-8">
              ...
              <TabsContent
                value="features"
                className="p-4 border border-t-0 rounded-b-lg bg-gray-50"
              >
