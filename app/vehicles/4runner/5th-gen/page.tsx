...
export default function FourRunnerFifthGenPage() {
  // Coming Soon categories for 5th Gen 4Runner
  ...
  // Baja Designs products for 5th Gen 4Runner (only ones with real photos)
  const bajaDesignsProducts = [
    {
      id: 3,
      name: "LP6 Pro LED Light (Clear)",
      price: "$399.95",
      image: "/images/baja-designs/lp6-pro-clear.jpg",
      link: "/products/baja-designs/3",
    },
    {
      id: 2,
  ...
  return (
    <div className="container px-4 py-12">
      ...
      <div className="flex items-center text-sm text-gray-400 mb-8">
        ...
        <ChevronRight className="h-4 w-4 mx-2" />
        <span className="text-gray-300">5th Gen (2010-2023)</span>
      </div>
      ...
      <div className="relative h-64 rounded-lg overflow-hidden mb-12">
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-4">5TH GEN 4RUNNER (2010-2023)</h1>
            <p className="text-xl text-gray-200 max-w-2xl mx-auto">
              Premium off-road accessories designed specifically for your 5th Gen Toyota 4Runner
            </p>
          </div>
        </div>
        <img
          src="/images/4runner-5th-gen-stock.jpg"
          alt="5th Gen Toyota 4Runner"
      ...
      <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-8 text-center mb-16">
        ...
        <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
          We're currently developing our line of products for the 5th Gen 4Runner. This popular generation will receive
          our full attention after completing the 4th Gen product line.
        </p>
        ...
        <p className="text-sm text-gray-400 mt-4">Be the first to know when 5th Gen products become available</p>
      </div>
