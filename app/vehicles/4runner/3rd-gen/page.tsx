...
export default function FourRunnerThirdGenPage() {
  // Coming Soon categories for 3rd Gen 4Runner
  ...
  // Baja Designs products for 3rd Gen 4Runner (only ones with real photos)
  ...
  return (
    <div className="container px-4 py-12">
      ...
      <div className="flex items-center text-sm text-gray-400 mb-8">
        ...
        <ChevronRight className="h-4 w-4 mx-2" />
        <span className="text-gray-300">3rd Gen (1996-2002)</span>
      </div>
      ...
      <div className="relative h-64 rounded-lg overflow-hidden mb-12">
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-4">3RD GEN 4RUNNER (1996-2002)</h1>
            <p className="text-xl text-gray-200 max-w-2xl mx-auto">
              Premium off-road accessories designed specifically for your 3rd Gen Toyota 4Runner
            </p>
          </div>
        </div>
        <img
          src="/images/4runner-3rd-gen-stock.jpg"
          alt="3rd Gen Toyota 4Runner"
      ...
      <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-8 text-center mb-16">
        ...
        <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
          We're currently developing our line of products for the 3rd Gen 4Runner. Our engineering team is working on
