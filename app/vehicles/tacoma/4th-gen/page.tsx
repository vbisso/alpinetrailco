...
export default function TacomaFourthGenPage() {
  // Categories for 4th Gen Tacoma
  const categories = [
    {
      id: "front-bumpers",
      name: "Front Bumpers",
    ...
    },
    {
      id: "bed-racks",
      name: "Bed Racks",
      image: "/placeholder.svg?height=600&width=800&text=Bed+Racks",
      description: "Heavy-duty bed rack systems for rooftop tents and gear storage.",
    },
  ]

  // Baja Designs products for 4th Gen Tacoma
  const bajaDesignsProducts = [
    {
      id: 2,
      name: 'S8 30" LED Light Bar (Amber)',
      price: "$899.95",
      image: "/images/baja-designs/light-bar-amber.jpg",
      link: "/products/baja-designs/2",
    },
    {
      id: 8,
  ...
  return (
    <div className="container px-4 py-12">
      ...
      <div className="flex items-center text-sm text-gray-400 mb-8">
        ...
        <ChevronRight className="h-4 w-4 mx-2" />
        <span className="text-gray-300">4th Gen (2024-Present)</span>
      </div>
      ...
      <div className="relative h-64 rounded-lg overflow-hidden mb-12">
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-4">4TH GEN TACOMA (2024-PRESENT)</h1>
            <p className="text-xl text-gray-200 max-w-2xl mx-auto">
              Premium off-road accessories designed specifically for your 4th Gen Toyota Tacoma
            </p>
          </div>
        </div>
        <img
          src="/images/tacoma-4th-gen-stock.jpg"
      ...
      <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-8 text-center mb-16">
        <h2 className="text-2xl font-bold text-white mb-4">PRODUCTS COMING SOON</h2>
        <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
          We're currently developing our line of products for the all-new 4th Gen Tacoma. Sign up to be notified when
          these products become available.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
          <input
            type="email"
            placeholder="Your email address"
            className="px-4 py-2 bg-zinc-700 border border-zinc-600 rounded-md text-white"
          />
