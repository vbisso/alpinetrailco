...
export default function TacomaThirdGenPage() {
  ...
  // Baja Designs products for 3rd Gen Tacoma (only ones with real photos)
    ...
    <div className="container px-4 py-12">
      ...
      <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-8 text-center mb-16">
        ...
        <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
          We're currently developing our line of products for the 3rd Gen Tacoma. This popular generation will receive
          our full attention after completing the 4th Gen 4Runner product line.
        </p>
