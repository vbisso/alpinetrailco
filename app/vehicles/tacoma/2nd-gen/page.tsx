...
export default function TacomaSecondGenPage() {
  // Coming Soon categories for 2nd Gen Tacoma
  ...
  // Baja Designs products for 2nd Gen Tacoma (only ones with real photos)
  ...
  return (
    <div className="container px-4 py-12">
      ...
      <div className="flex items-center text-sm text-gray-400 mb-8">
        ...
        <ChevronRight className="h-4 w-4 mx-2" />
        <span className="text-gray-300">2nd Gen (2005-2015)</span>
      </div>
      ...
      <div className="relative h-64 rounded-lg overflow-hidden mb-12">
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-4">2ND GEN TACOMA (2005-2015)</h1>
            <p className="text-xl text-gray-200 max-w-2xl mx-auto">
              Premium off-road accessories designed specifically for your 2nd Gen Toyota Tacoma
            </p>
          </div>
        </div>
        <img
          src="/images/tacoma-2nd-gen-stock.avif"
          alt="2nd Gen Toyota Tacoma"
      ...
      <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-8 text-center mb-16">
        ...
        <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
          We're currently developing our line of products for the 2nd Gen Tacoma. Our engineering team is working on
        ...
        <p className="text-sm text-gray-400 mt-4">Be the first to know when 2nd Gen products become available</p>
      </div>
