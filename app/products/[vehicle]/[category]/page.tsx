...
export default function ProductCategoryPage({
  ...
  // Grab products from dictionary
  const categoryProducts = products[vehicle]?.[category];
    ...
    <div className="container px-4 py-12">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">
          {vehicle.toUpperCase()} {category.toUpperCase()}
        </h1>
        <p className="text-gray-300">
          Premium {category} designed specifically for your {vehicle}.
        </p>
      </div>
